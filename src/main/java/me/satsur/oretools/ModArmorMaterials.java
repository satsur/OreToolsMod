...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    COAL("coal", 20, new int[]{1, 4, 6, 2}, 12, SoundEvents.ARMOR_EQUIP_DIAMOND,
            0F, 0F, () -> Ingredient.of(Items.COAL));
    ...
    private ModArmorMaterials(String name, int durabilityMultiplier, int[] slotProtections, int enchantmentValue, SoundEvent sound,
                              float toughness, float kbResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
